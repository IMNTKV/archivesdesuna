...
const PAGES = {
  sommaire: {
    ...
    html: `
      ...
      <p style="text-align:center; font-family:'Cinzel',serif; font-size:14px; letter-spacing:3px; color:var(--sand-deep); margin-bottom:30px;">DOCUMENT À USAGE ÉDUCATIF — Rédigé par la Section Archéologique</p>
  ...
  clans_majeurs: {
    ...
    html: `
      ...
      <div class="clan-card">
        ...
        <p><strong style="color:var(--ink-dark); font-family:'Cinzel', serif;">Culture & Philosophie :</strong><br> Au fil des générations, le clan se scinda en deux branches distinctes.<br><br>
Lignée Bunraku Ayatsuri : Gardienne fanatique des traditions. Elle refuse toute ouverture, considère le métissage comme une souillure et l'adoption comme une trahison du sang. Pour eux, un Ayatsuri doit naître Ayatsuri.<br><br>
Lignée Gin Ayatsuri : Plus ouverte, elle accepte l'adoption et les alliances extérieures, convaincue que l'art des fils doit se perpétuer à travers tous ceux qui sont dignes de le porter, au-delà du seul sang</p>
        <p><strong style="color:var(--ink-dark); font-family:'Cinzel', serif;">La Bataille des Cordes:</strong><br>Événement fondateur gravé dans la mémoire du clan, la Bataille des Cordes marqua le retour des deux frères contre leur tribu d'origine. Ce conflit brutal, où les premières marionnettes de guerre furent déployées, scella à jamais l'identité des Ayatsuri : un peuple forgé dans la trahison, la technique et la volonté de ne jamais se soumettre. Chaque génération perpétue son souvenir comme un serment silencieux.</p>
        <p><strong style="color:var(--ink-dark); font-family:'Cinzel', serif;">Relations & Influence :</strong><br>Au sein du clan, une branche se distinguait : les Nozuke. Ces experts en combat rapproché servaient de garde du corps aux marionnettistes, frappant là où les fils ne pouvaient atteindre. Boucliers vivants du clan, ils en étaient la protection physique et les formateurs au combat traditionnel.
<br><br>
À Sunagakure, le clan Ayatsuri est rattaché à la Section de la Forge, dont il constitue l'un des piliers, ainsi qu'à la sous-section Technologique de la Section Scientifique. Ingénieurs, concepteurs et artisans de guerre, ils sont les architectes silencieux de l'armement du village.</p>
        <p><strong style="color:var(--ink-dark); font-family:'Cinzel', serif;">Capacités :</strong><br>Les Ayatsuri portent en eux un noyau de chakra condensé à la place du cœur, les liant irrémédiablement à leur art. Ils maîtrisent les fils de chakra avec une précision chirurgicale, animant leurs marionnettes comme d'autres manient une lame. Ces créations mécaniques sont à la fois leurs armes, leurs outils et leurs œuvres.<br><br>Aujourd'hui presque éteint, le clan reste dans la mémoire du Pays du Vent comme les Tisseurs de Guerre : des artisans d'ombre capables de transformer le silence en arme, et l'arme en légende.</p>
      </div>
...
function startAmbientAudio() {
  ...
  ambientAudio.play().then(() => {
    ...
    window.removeEventListener('touchend', startAmbientAudio);
  }).catch(() => {
...
window.addEventListener('load', () => {
  ...
  window.addEventListener('touchend', startAmbientAudio, { once: true });
});
